...
,CONSTRAINT perf_fk 
	FOREIGN KEY(theatre_performance,season)	REFERENCES performance(theatre_performance,season)
);
...
,CONSTRAINT res_perf_perf_date 
	FOREIGN KEY(theatre_performance, date_time) REFERENCES performance_date(theatre_performance, date_time)
);
...
,CONSTRAINT reh_th_per_fk 
	FOREIGN KEY(theatre_performance,date_starttime) REFERENCES rehearsal(theatre_performance,date_starttime)
);
